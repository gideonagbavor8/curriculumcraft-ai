        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-green-100 mx-auto mb-4">
              <Library size={28} className="text-green-700" />
            </div>
          ...
          <div className="space-y-3">
            ...
            {lessons.map((lesson) => (
              <div
                key={lesson.id}
                className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 hover:border-green-200 transition-all"
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <Link
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-green-50 border border-green-200 text-green-700 text-xs font-medium hover:bg-green-100 transition-all"
                    >
                      <BookOpen size={12} />
                      View
                    </Link>
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-red-50 border border-red-200 text-red-600 text-xs font-medium hover:bg-red-100 transition-all disabled:opacity-50"
                    >
                      {deleting === lesson.id ? (
